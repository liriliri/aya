...
export const colorSplit = `rgba(5, 5, 5, 0.06)`
...
export const controlOutline = `rgba(22, 130, 5, 0.12)`
...
export const colorBorderDark = `#424242`
...
export const colorBorderBgDark = `#141414`
export const colorSplitDark = `rgba(253, 253, 253, 0.12)`
...
export const colorErrorOutlineDark = `rgba(238, 38, 56, 0.11)`
export const colorWarningOutlineDark = `rgba(173, 107, 0, 0.15)`
