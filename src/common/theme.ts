...
export const colorPrimaryBg = `#e3f0e1`
export const colorPrimaryBgHover = `#d6e3d5`
export const colorPrimaryBorder = `#c8d6c7`
export const colorPrimaryBorderHover = `#9bc99b`
export const colorPrimaryHover = `#73bd76`
export const colorPrimaryActive = `#378a3f`
export const colorPrimaryTextHover = `#73bd76`
export const colorPrimaryText = `#4fb155`
export const colorPrimaryTextActive = `#378a3f`
...
export const colorBorderBg = `#f7f8fa`
export const colorSplit = `rgba(72, 48, 0, 0.04)`
...
export const colorErrorOutline = `rgba(255, 242, 239, 0.95)`
export const colorWarningOutline = `rgba(255, 251, 229, 0.95)`
export const fontSizeIcon = `12`
export const lineWidthFocus = `4`
export const controlOutlineWidth = `2`
export const controlInteractiveSize = `16`
export const controlItemBgHover = `rgba(0, 0, 0, 0.04)`
export const controlItemBgActive = `#e3f0e1`
export const controlItemBgActiveHover = `#d6e3d5`
export const controlItemBgActiveDisabled = `rgba(0, 0, 0, 0.15)`
export const controlTmpOutline = `rgba(0, 0, 0, 0.02)`
export const controlOutline = `rgba(47, 168, 0, 0.1)`
...
// dark
export const colorPrimaryDark = `#46994b`
...
export const colorBgContainerDark = `#2b2d30`
export const colorBorderDark = `#4e5157`
...
export const colorPrimaryBgDark = `#162017`
export const colorPrimaryBgHoverDark = `#1d321f`
export const colorPrimaryBorderDark = `#264328`
export const colorPrimaryBorderHoverDark = `#2f5b31`
export const colorPrimaryHoverDark = `#6aac6c`
export const colorPrimaryActiveDark = `#3a7a3e`
export const colorPrimaryTextHoverDark = `#6aac6c`
export const colorPrimaryTextDark = `#46994b`
export const colorPrimaryTextActiveDark = `#3a7a3e`
...
export const colorBorderBgDark = `#2b2d30`
export const colorSplitDark = `rgba(210, 145, 48, 0.03)`
...
export const colorErrorOutlineDark = `rgba(45, 0, 1, 0.51)`
export const colorWarningOutlineDark = `rgba(43, 26, 0, 0.64)`
